...
export function TabViewerPanel({ tabSourceUrl, currentTime, isPlaying }: TabViewerPanelProps) {
  ...
  if (!tabSourceUrl) {
    return (
      <div className="rounded-xl border px-4 py-3 text-sm" style={{ borderColor: "rgba(192, 192, 192, 0.06)", background: "rgba(17, 22, 56, 0.5)", color: "#7a7a90" }}>
  ...
  return (
    <div className="rounded-xl border p-3" style={{ borderColor: "rgba(192, 192, 192, 0.06)", background: "rgba(17, 22, 56, 0.7)", backdropFilter: "blur(12px)" }}>
      <h3 className="mb-2 text-xs font-medium uppercase tracking-widest" style={{ fontFamily: "Orbitron, sans-serif", color: "#7a7a90", fontSize: "0.6rem" }}>Tab Viewer</h3>
