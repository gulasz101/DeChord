  ...
  return (
    <div className="space-y-3">
      {Array.from(groups.entries()).map(([key, versions]) => {
        ...
        return (
          <div key={key} className="border p-3" style={{ borderRadius: "4px", borderColor: isActive ? "rgba(124, 58, 237, 0.25)" : "rgba(192, 192, 192, 0.06)", background: isActive ? "rgba(17, 22, 56, 0.7)" : "rgba(17, 22, 56, 0.4)", backdropFilter: "blur(8px)" }}>
            ...
            {versions.length > 1 && (
              <div className="mt-2 pl-[38px]">
                <label className="mb-1 block text-[10px] font-medium" style={{ fontFamily: "Playfair Display, serif", color: "#7a7a90" }}>Version</label>
