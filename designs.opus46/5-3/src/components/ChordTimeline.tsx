...
export function ChordTimeline({ chords, currentIndex, currentTime, loopStart, loopEnd, noteChordIndexes, onChordClick }: ChordTimelineProps) {
  ...
  if (!showAll) {
    ...
    return (
      <div className="border p-3" style={{ borderRadius: "4px", borderColor: "rgba(192, 192, 192, 0.06)", background: "rgba(17, 22, 56, 0.5)", backdropFilter: "blur(8px)" }}>
        {/* Section header + toggle */}
        <div className="mb-2 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="text-xs font-semibold" style={{ fontFamily: "Playfair Display, serif", color: "#a78bfa" }}>{currentSectionName}</span>
  ...
  return (
    <div className="border p-3" style={{ borderRadius: "4px", borderColor: "rgba(192, 192, 192, 0.06)", background: "rgba(17, 22, 56, 0.5)", backdropFilter: "blur(8px)" }}>
      ...
      <div className="mb-3 flex items-center justify-between">
        <span className="text-xs font-semibold" style={{ fontFamily: "Playfair Display, serif", color: "#a78bfa" }}>All Sections</span>
          ...
          return (
            <div key={`${section.name}-${section.startIndex}`}>
              <div className="mb-1 flex items-center gap-2">
                <span className="text-[11px] font-semibold" style={{ fontFamily: "Playfair Display, serif", color: isCurSection ? "#a78bfa" : "#5a5a6e" }}>
                  {section.name}
                </span>
