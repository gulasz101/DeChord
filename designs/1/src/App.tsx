...
const DESIGN = {
  id: "ibm",
  name: "Design 1",
  title: "IBM-Inspired Product System",
  tagline: "Precise collaboration for tight rehearsal loops.",
  hero: "Band workspace for stems, tabs, comments, and repeatable practice.",
