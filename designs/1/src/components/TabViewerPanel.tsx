...
export function TabViewerPanel({ tabSourceUrl, currentTime, isPlaying }: TabViewerPanelProps) {
  ...
  if (!tabSourceUrl) {
    return (
      <div className="rounded-xl border px-4 py-3 text-sm" style={{ borderColor: "rgba(196, 168, 130, 0.1)", background: "rgba(26, 18, 9, 0.5)", color: "#8b7d6b" }}>
  ...
  return (
    <div className="rounded-xl border p-3" style={{ borderColor: "rgba(196, 168, 130, 0.12)", background: "rgba(26, 18, 9, 0.7)" }}>
      <h3 className="mb-2 text-xs font-medium uppercase tracking-widest" style={{ color: "#8b7d6b" }}>Tab Viewer</h3>
