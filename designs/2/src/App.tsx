...
const DESIGN = {
  id: "daw",
  name: "Design 2",
  title: "DAW-Inspired Studio Console",
  tagline: "A rehearsal room that behaves more like a control surface.",
  hero: "Switch stems, compare takes, and rehearse inside a studio-flavored collaboration shell.",
