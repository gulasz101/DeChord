...
const DESIGN = {
  id: "editorial",
  name: "Design 3",
  title: "Editorial Modern Workspace",
  tagline: "A sharper, more story-led collaboration surface.",
  hero: "Rehearsal review presented with editorial rhythm instead of generic app chrome.",
