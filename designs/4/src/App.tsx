...
const DESIGN = {
  ...
  tagline: "Quiet surfaces built for careful listening and small-band trust.",
  hero: "A calm rehearsal workspace that keeps rich song detail readable instead of loud.",
