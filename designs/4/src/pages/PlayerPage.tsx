    ...
    <div className="flex h-screen flex-col" style={{ background: "#f5f5f5" }}>
      ...
      <nav className="flex shrink-0 items-center justify-between px-6 py-3" style={{ borderBottom: "3px solid #000", background: "#000" }}>
        <div className="flex items-center gap-4">
          <button onClick={onBack} className="text-sm font-bold uppercase tracking-wider transition-colors hover:text-yellow-300" style={{ color: "#FFE500" }}>&larr; Back</button>
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => togglePanel("stems")}
            ...
            style={{ border: `2px solid ${sidePanel === "stems" ? "#FFE500" : "#555"}`, color: sidePanel === "stems" ? "#FFE500" : "#888", background: "transparent" }}>
          ...
          <button onClick={() => togglePanel("comments")}
            className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-bold uppercase tracking-wider transition-colors"
            style={{ border: `2px solid ${sidePanel === "comments" ? "#FFE500" : "#555"}`, color: sidePanel === "comments" ? "#FFE500" : "#888", background: "transparent" }}>
        ...
        {sidePanel !== "none" && (
          <aside className="w-80 shrink-0 overflow-y-auto p-4" style={{ borderLeft: "3px solid #000", background: "#fff" }}>
            {sidePanel === "stems" && (
              <>
                <div className="mb-4 flex items-center justify-between">
                  <h3 className="text-sm font-bold uppercase" style={{ fontFamily: "Archivo Black, sans-serif", color: "#000" }}>Stems</h3>
                  <span className="text-[10px] font-bold uppercase" style={{ color: "#888" }}>{activeStemKeys.size} of {activeStemCount} active</span>
                </div>
            ...
            {sidePanel === "comments" && (
              <>
                <div className="mb-4 flex items-center justify-between">
                  <h3 className="text-sm font-bold uppercase" style={{ fontFamily: "Archivo Black, sans-serif", color: "#000" }}>Comments</h3>
                  <span className="text-[10px] font-bold uppercase" style={{ color: "#888" }}>{openCommentCount} open</span>
                </div>
