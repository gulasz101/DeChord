...
- [x] Task 3: Run reset + targeted/full verification, execute canonical Hysteria/Trooper evaluations, generate Phase 4 report artifacts, and finalize plan checkboxes.
